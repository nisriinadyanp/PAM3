    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Button b : nums) {
            b.setOnClickListener(view -> {
                if (!screen.getText().toString().equals("0")){
                    operation = screen.getText().toString() + b.getText().toString();
                    screen.setText(operation);
                } else {
                    screen.setText(b.getText().toString());
                }
                operationn = screen2.getText().toString() + b.getText().toString();
                screen2.setText(operationn);
            });
        }
        ...
        for (Button b : opers) {
            b.setOnClickListener(view -> {
                ...
                operationn = screen.getText().toString() + b.getText().toString();
                screen.setText("0");
                screen2.setText(operationn);
            });
        }
